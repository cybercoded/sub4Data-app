              ...
              API.post(`register.php`, values)
                .then((res) => {
                  if ( res.data.status === true ) {
                    valueDispatch({loader: {...dummies.modalProcess.success, text: <Text style={{color: theme.colors.primary}}>{res.data.message}</Text>}});
                    ...
                    valueDispatch({loader: {...dummies.modalProcess.loading, text: 'Something went wrong'}});
                  }
                })
                .catch((err) => {
                  valueDispatch({loader: {...dummies.modalProcess.loading, text: err.message}});
