...
export const VerifyPin = ({navigation, action, title, closePinScreen, isVisible}) => {
    ...
    return (
        ...
        <Overlay isVisible={isVisible} onBackdropPress={false} fullScreen={true}>
            ...
            <Button 
                type="clear" 
                titleStyle={{color: theme.colors.dim}}  
                onPress={closePinScreen} title="Go back" 
            />
            <Button 
                type="clear" 
                onPress={() => { 
                    closePinScreen();
                    navigation.navigate('VerifyOtpPIn');
                }} 
